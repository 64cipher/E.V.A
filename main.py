...
- "execute_multi_step_agent": {"task": "La description complète de la tâche complexe que l'agent doit accomplir." (ex: "plusieurs étapes", "étape par étape", "en tant qu'agent", "utilise l'agent", "résume ce pdf", "analyse ce pdf", "recherche approfondie", "analyse comparative", "identification d'informations dans une image", "localiser un lieu sur une photo")}
